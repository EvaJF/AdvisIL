...
root_dir = "/home/efeillet/Code/AdvisIL/testsets" # for saving result df

log_dirs = ['/home/efeillet/Code/AdvisIL_results/logs_testsets']
log_files = []
for dir in log_dirs : 
...
# DEESIL
log_files_deesil = [file for file in log_files if "deesil" in file]

# Deep SLDA
log_files_slda = [file for file in log_files if "slda" in file]

# LUCIR, SPB, SIW 
log_files_other = [file for file in log_files if "slda" not in file and "deesil" not in file]

### Utility functions for parsing ###

#TODO update which scenario function to take into account test scenarios too
...
print("\n\nDeepSLDA : ", slda_start, slda_end)
print("DeeSIL : ", deesil_start, deesil_end)
print("Total:", n_results)

# fill result table 
result_df = pd.DataFrame(rows, columns = columns)
print(result_df[result_df.method=="slda"])
...
result_df.to_csv(os.path.join(root_dir, "advisIL_test_raw_logs.csv"))
# check for doublons 
...
#print(avg_df)
avg_df.to_csv(os.path.join(root_dir, "advisIL_test_avg_logs.csv"))
...
check_df.to_csv(os.path.join(root_dir, "check_advisIL_test_logs.csv"))
print(check_df)
