...
destination_path = "/home/data/efeillet/expe/test/yaml_files"
...
state_list = [("equi_s5_B20_P20", 5, 20, 20),  ("equi_s25_B4_P4", 25, 4, 4),  ("equi_s50_B2_P2", 50, 2, 2), 
              ("semi_s13_B40_P5", 13, 40, 5),  ("semi_s11_B50_P5", 11, 50, 5),  ("semi_s6_B50_P10", 6, 50, 10)] # ("semi_s3", 3, 50, 25),  ("semi_s6", 6, 50, 10),  ("semi_s11", 11, 50, 5)

for (prefix, last_batch_number, B, P) in state_list : 
    assert(B+(last_batch_number-1)*P == 100)
    assert(prefix.endswith("s{}_B{}_P{}".format(last_batch_number, B, P)))
    if B == P : 
...
dataset_list = [ "imagenet_random_2"] #"inat", "food101", "google_landmarks",
